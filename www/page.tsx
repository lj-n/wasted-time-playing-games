...
import { Fragment, h, render } from "nano_jsx";
...
export function Page({ error, games, profile }: PageProps) {
  const Form = render(
    <form action="/">
      ...
      <div class="info">
        <p>
          If you provide no Steam Web Api Key, the Steam ID's user profile must
          be public! You can{" "}
  ...
  return (
    <html lang="en">
      ...
      <body>
        ...
        <footer>
          <a href="https://github.com/lj-n/wasted-time-playing-games">
            Sourcecode
          </a>
        </footer>
      </body>
